...
const imageLogo1 = require('./assets/favicon.png')
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'plum', padding: 30 }}>
      <ScrollView>
        ...
        <Pressable onPress={() => console.log('Pressable click')}>
          <Image source={imageLogo} style={{ height: 300, width: 300 }} />
        </Pressable>
        <Text>
      ...
      {/* <ImageBackground source={imageLogo} style={{ flex: 1 }}>
        <Text>
          <Text style={{ color: 'white' }}> Hello World</Text>
        </Text>
        <Image source={imageLogo1} style={{ width: 100, height: 100 }} />
        <Image
